...
prediction.feature = ['Rainfall','Cloud_Coverage','Bright_Sunshine','Wind_Speed','Max_Temp','Min_Temp','Relative_Humidity'] #features used. Possible:'Cloud_Coverage','Bright_Sunshine','Wind_Speed','Max_Temp','Min_Temp','Relative_Humidity','Sl','Year','Month', 'Station_Number', 'X_COR', 'Y_COR', 'LATITUDE', 'LONGITUDE', 'ALT', 'Period'
prediction.test_size = 0.3

prediction.preprocess()     #clear Dataset
prediction.split()          #split into test and train

#prediction.LR_train(all=True)         #Logistic Regression
